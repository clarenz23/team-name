...
/**
 This class represents a part that is processed by the drill press.
 It stores the necessary values for the simulation, such as the part number, arrival time, and service time.
 */
public class Part {
